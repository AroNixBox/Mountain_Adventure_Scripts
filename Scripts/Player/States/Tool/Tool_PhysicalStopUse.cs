...
{
    public class Tool_PhysicalStopUse : IState
    {
        ...
        public Tool_PhysicalStopUse(PlayerReferenceManager playerReferenceManager)
        {
        ...
        public void OnExit()
        {
            ...
            _playerReferences.ToolStopUseAnimEvent = false;
            _playerReferences.WonMiniGame = false;
            _playerReferences.LostMiniGame = false;
        }
        public Color GizmoState()
        {
            return new Color(1.0f, 0.07f, 0.57f);
        }
    }
}
