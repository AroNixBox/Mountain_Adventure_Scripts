...
{
    public class Tool_AnimWonMinigame : IState
    {
        ...
        public Tool_AnimWonMinigame(PlayerReferenceManager playerReferenceManager)
        {
        ...
        public void OnEnter()
        {
            ...
            {
                _animator.SetTrigger(tool.GetWonMinigameActionHash());
            }
            else
            {
        ...
        {
            return new Color(0.73f, 0.16f, 0.96f);
        }
    }
}