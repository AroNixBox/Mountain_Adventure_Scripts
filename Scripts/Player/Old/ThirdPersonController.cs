...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private bool _isJumpingDisabled;
        ...
        private void Start()
        {
            _hasAnimator = _animator = _playerReferenceManager.Animator;
        ...
        private void Move()
        {
            ...
            if (_input.move == Vector2.zero || _isMovementDisabled) targetSpeed = 0.0f;
            ...
            if (_input.move != Vector2.zero && !_isMovementDisabled)
            {
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_input.jump && _jumpTimeoutDelta <= 0.0f && !_isJumpingDisabled)
                {
